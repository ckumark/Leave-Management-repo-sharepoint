...
var LeaveManagementPortal = /** @class */ (function (_super) {
    ...
    LeaveManagementPortal.prototype.getApproverEmail = function (userId) {
        return this.state.AvailableUsers.filter(function (user) { return user.ID === userId; })[0]
            .Email;
    };
    ...
    LeaveManagementPortal.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.mainContainer },
            ...
            this.state.currentState === 6 /* WelcomePage */ &&
                this.state.IsUserSelected && (React.createElement(WelcomeNote, { digest: this.state.digest, context: this.state.context, User: this.state.User })),
            (this.state.currentState === 1 /* SwitchUser */ ||
                !this.state.IsUserSelected) && (React.createElement(SwitchUser, { digest: this.state.digest, context: this.state.context, switchUser: this.selectUser, SearchUsers: this.SearchUsers, AvailableUsers: this.state.AvailableUsers, switchState: this.switchState, setMessage: this.setMessage })),
            this.state.currentState === 2 /* PolicyUpload */ &&
                this.state.IsUserSelected && (React.createElement(PolicyUpload, { digest: this.state.digest, context: this.state.context, setMessage: this.setMessage, IsAdmin: this.IsAdmin })),
            this.state.currentState === 4 /* PendingApprovals */ &&
                this.state.IsUserSelected && (React.createElement(PendingApprovals, { digest: this.state.digest, context: this.state.context, userId: this.state.User.ID, setMessage: this.setMessage })),
            this.state.currentState === 5 /* LeaveApplication */ &&
                this.state.IsUserSelected && (React.createElement(LeaveApplication, { digest: this.state.digest, context: this.state.context, userId: this.state.User.Email, setMessage: this.setMessage, switchState: this.switchState, hrUsers: this.state.AvailableUsers.filter(function (user) { return user.IsAdmin && user.Email !== _this.state.User.Email; }) })),
            this.state.currentState === 3 /* ApplicationHistory */ &&
                this.state.IsUserSelected && (React.createElement(LeavesHistory, { digest: this.state.digest, context: this.state.context, userId: this.state.User.Email, getApproverEmail: this.getApproverEmail, setMessage: this.setMessage, IsAdmin: this.IsAdmin }))));
        // return (
