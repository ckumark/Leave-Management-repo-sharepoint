...
var PendingApprovals = /** @class */ (function (_super) {
    ...
    PendingApprovals.prototype.RetrievePendignApprovals = function () {
        var _this = this;
        PendingApprovalsAPI.getPendingApprovals(this.props.userId)
    ...
    PendingApprovals.prototype.RejectRequest = function (RequestID) {
        var _this = this;
        PendingApprovalsAPI.updatePendingRequest(RequestID, "Rejected" /* Rejected */)
    ...
    PendingApprovals.prototype.ApproveRequest = function (RequestID) {
        var _this = this;
        PendingApprovalsAPI.updatePendingRequest(RequestID, "Approved" /* Approved */)
            .then(function (response) {
            if (response === true) {
            ...
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "row mt-5 pt-5" },
                    React.createElement("div", { className: "col text-center" },
                        ...
                        this.pendingApprovals.length > 0 && (React.createElement("table", null,
                            ...
                            React.createElement("tbody", null,
                                this.pendingApprovals.map(function (pendingRequest) {
                                    return (React.createElement("tr", null,
                                        ...
                                        pendingRequest.Status.toLowerCase() ===
                                            "Pending" /* Pending */.toLowerCase() && (React.createElement("td", null,
                                            React.createElement("button", { onClick: function () {
                                                    return _this.ApproveRequest(pendingRequest.RequestID);
                                                } }, "Approve"),
                                            React.createElement("button", { onClick: function () {
                                                    return _this.RejectRequest(pendingRequest.RequestID);
                                                } },
                                                " ",
                                                "Reject"))),
                                        pendingRequest.Status.toLowerCase() ===
                                            "Pending" /* Pending */.toLowerCase() && (React.createElement("td", null, pendingRequest.Status))));
                                }),
                                React.createElement("tr", null)))))))));
    };
