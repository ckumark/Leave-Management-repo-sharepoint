                ...
                React.createElement("div", { className: "row mt-5 pt-5" },
                    React.createElement("div", { className: "col text-center" },
                        ...
                        (this.leaveRequests === null ||
                            this.leaveRequests.length <= 0) && (React.createElement("div", null, "No Leave requests found for the user")),
                        this.leaveRequests != null && this.leaveRequests.length > 0 && (React.createElement("table", null,
                                ...
                                return (React.createElement("tr", null,
                                    ...
                                    request.Status.toLowerCase() ===
                                        ...
                                        React.createElement("button", { onClick: function (event) {
                                                return _this.cancelLeaveRequest(request.RequestID);
                                            } }, "Cancel Request"))) : (React.createElement("td", null, " Action not available"))));
                            })))))))));
    };
