...
> {
  ...
  public applyLeave(): void {
    ...
    LeaveApplicationAPI.applyLeave(
      this.props.userId,
      approverId,
      new Date(leaveDate)
    ).then((response) => {
      if (response === true) {
        this.props.setMessage(
          "Leave request has been forwarded. Please check your request status for more information.",
          InfoState.Informational
        );
        this.props.switchState(PageState.WelcomePage);
      } else {
        this.props.setMessage(
          "Failed to request for leave. Please try again",
          InfoState.Error
        );
      }
    });
          ...
          <div className="row mt-5 pt-5">
            <div className="col text-center">
              ...
              <div>
                ...
                <div>
                  Available approvers:{" "}
                  <select id="Approver" ref={this.approverId}>
