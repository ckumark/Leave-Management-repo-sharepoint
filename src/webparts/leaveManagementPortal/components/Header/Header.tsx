        ...
        <nav className={styles.header}>
          <div className={styles.headerTitle}>
            <h1 className={styles.title}>
              <strong>Leave Management Portal</strong>
            </h1>
          ...
          <div>
            <ul className={styles.navbar}>
              ...
              {this.props.IsUserSelected && this.props.User.IsAdmin && (
                <li className={styles.navItem}>
                  <a
                    onClick={(event) => {
          ...
          {this.props.ActionInfo.Message != undefined &&
            this.props.ActionInfo.Message.length > 0 && (
              <div>{this.props.ActionInfo.Message}</div>
            )}
          <div></div>
        </nav>
      </header>
