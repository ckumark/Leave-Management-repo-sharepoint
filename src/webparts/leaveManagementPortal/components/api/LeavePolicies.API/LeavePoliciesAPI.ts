...
export default class LeavePoliciesAPI {
  public static async getLeavePolicies(
  ...
  public static async uploadLeavePolicies(
    context: IWebPartContext,
    libraryName: string,
    fileName: string,
    file: File,
    ...
    let response = await LibraryFactory.uploadLibraryItem(
      context,
      libraryName,
      fileName,
      file,
  ...
  public static async removeLeavePolicy(
    context: IWebPartContext,
    libraryName: string,
    fileName: string
  ): Promise<boolean> {
    try {
      let response = await LibraryFactory.removeLibraryItem(
        context,
        libraryName,
        fileName
      );
